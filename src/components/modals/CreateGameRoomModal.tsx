 ...
 *
 * Session 2 — renamed from `CreateRoomModal` to `CreateGameRoomModal`.
 * `CREATE_ROOM`/`CreateRoomModal` now means a plain chat/call room (Rooms
 * tab, via `rooms.createRoom`); this modal keeps the exact same
 * `createGameRoom` game-room behavior, just under `CREATE_GAME_ROOM` and
 * only reachable from the Game Hub tile.
 */
export function CreateGameRoomModal() {
