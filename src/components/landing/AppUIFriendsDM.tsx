...
const DEMO_MESSAGES: MessageWithSender[] = [
  ...
  {
    _id: "demo-msg-5" as unknown as Id<"messages">,
    conversation_id: "demo-convo",
    conversation_type: "direct",
    sender_id: DEMO_FRIEND.user_id,
    content: "hii",
    ...
    type: "text",
    file_name: null,
    _creationTime: Date.UTC(2026, 7, 25, 18, 29),
    sender: { user_id: DEMO_FRIEND.user_id, username: DEMO_FRIEND.username, avatar: DEMO_FRIEND.avatar },
  },
  {
    _id: "demo-msg-6" as unknown as Id<"messages">,
    conversation_id: "demo-convo",
    conversation_type: "direct",
    sender_id: DEMO_FRIEND.user_id,
    content: "yeah let's do it, I'll hop in the room",
    file_url: null,
    type: "text",
    file_name: null,
    _creationTime: Date.UTC(2026, 7, 25, 18, 30),
    sender: { user_id: DEMO_FRIEND.user_id, username: DEMO_FRIEND.username, avatar: DEMO_FRIEND.avatar },
  },
  {
    _id: "demo-msg-7" as unknown as Id<"messages">,
    conversation_id: "demo-convo",
    conversation_type: "direct",
    sender_id: DEMO_USER.user_id,
    content: "on my way",
    ...
    type: "text",
    file_name: null,
    _creationTime: Date.UTC(2026, 7, 25, 18, 32),
    sender: DEMO_USER,
  },
];
